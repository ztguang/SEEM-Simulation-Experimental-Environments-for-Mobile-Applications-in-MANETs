...
cp out/lib/libzebra.so /lib64/
cp out/lib/libospf.so /lib64/
cp out/lib/libospfapiclient.so /lib64/
cp out/lib/libstlport_shared.so /lib64/
cp out/lib/libc++_shared.so /lib64/
